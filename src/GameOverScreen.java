...
public class GameOverScreen implements Animation {
    ...
    /**
     * This is a constructor method that initiates a GameOverScreen object using a given score counter.
     *
    ...
    public void doOneFrame(DrawSurface d) {
        d.drawText(TEXT_X, d.getHeight() / 2, "Game Over. Your score is " + this.getScore().getValue(), TEXT_SIZE);
    }
